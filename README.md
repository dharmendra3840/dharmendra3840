...
<div align="center">
  ...
  [![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=22&duration=3000&pause=1000&color=6C63FF&center=true&vCenter=true&multiline=true&repeat=true&width=600&height=100&lines=%F0%9F%9A%80+Turning+Ideas+Into+Scalable+Products;%F0%9F%8E%AF+MERN+Stack+%7C+Next.js+%7C+System+Design;%E2%9A%A1+Clean+Code+%E2%80%A2+Smart+Architecture+%E2%80%A2+Ship+Fast)](https://github.com/dharmendra3840)
...
<div align="center">
  ...
  <a href="mailto:dharmendrak3327mahato@gmail.com"><img src="https://img.shields.io/badge/Hire%20Me-Available-00D2FF?style=for-the-badge&logo=gmail&logoColor=white"/></a>
  <img src="https://komarev.com/ghpvc/?username=dharmendra3840&style=for-the-badge&color=6C63FF&label=PROFILE+VIEWS"/>
  <a href="https://github.com/dharmendra3840?tab=followers"><img src="https://img.shields.io/github/followers/dharmendra3840?style=for-the-badge&color=6C63FF&labelColor=0d1117&logo=github"/></a>
...
location: India 🇮🇳
available_for: freelance, full-time, open-source
...
<br/>
🔐 Real-time scoring + user authentication system
<br/>
🎯 Clean MVC pattern with RESTful APIs
...
const dharmendra = {
    ...
    architecture: {
        frontend:  "Component-driven → Reusable → Scalable",
        backend:   "Microservices → REST/GraphQL → Clean APIs",
        database:  "Schema-first → Indexed → Optimized",
    },

    principles: [
        "Write code that humans can read",
        "Automate everything you do twice",
        "Ship MVP fast, iterate with data",
    ...
    askMeAbout: [
        "MERN Stack", "System Design", "API Architecture",
...
To activate the **contribution snake animation**, create this file in your profile repository:
  ...
  build:
    ...
    steps:
      - name: Generate Snake
        uses: Platane/snk@v3
        with:
          github_user_name: dharmendra3840
          outputs: |
